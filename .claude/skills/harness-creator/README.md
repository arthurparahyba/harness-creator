...
| 2.6 | Escolher a variante de `<como-propor-mudanca-de-plano>`: as duas fontes (com `openspec/`) ou só TASKS.md | `02-preenchimento-templates.md` | Mandar usar `/opsx:propose` num repo sem OpenSpec é instruir o agente a chamar um comando que não existe. E onde as duas existem, variante sem critério faz a escolha cair na ordem dos arquivos |
